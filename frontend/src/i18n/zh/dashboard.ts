...
export default {
  ...
  'endpoint_comfyui_video_display': 'ComfyUI（本地）',
  'endpoint_openai_tts_display': 'OpenAI 语音合成 (TTS)',
  'endpoint_catalog_loading': '加载端点目录…',
  // ComfyUI 工作流配置（comfyui-video endpoint 模型行内）
  'comfyui_workflow_label': '工作流',
  'comfyui_workflow_template_label': '内置模板',
  'comfyui_workflow_template_minimax_h3_ref2va': '标准 20 步 Ref2VA',
  'comfyui_workflow_template_minimax_h3_ref2va_8step': '8 步 Turbo LoRA',
  'comfyui_workflow_template_minimax_h3_ref2va_8step_fp8': '8 步 Turbo LoRA (FP8)',
  'comfyui_workflow_follow_default': '跟随内置模板',
  'comfyui_workflow_no_template': '选择内置模板起步',
  'comfyui_workflow_edit_json': '编辑 JSON',
  'comfyui_workflow_hide_json': '收起 JSON',
  'comfyui_workflow_help_custom': '自定义模型需要覆盖工作流：先选一个内置模板作起点，再按需修改 JSON。模板必须包含 MiniMaxH3ReferenceToVideo 与 SaveVideo 节点。',
  'comfyui_workflow_json_label': '覆盖工作流 JSON',
  'comfyui_workflow_json_placeholder': '{"节点ID": {"class_type": "...", "inputs": {...}}, ...}',
  'comfyui_workflow_json_invalid': 'JSON 解析失败，请检查语法',
  'comfyui_workflow_json_not_graph': 'JSON 不是合法的 ComfyUI 工作流图（须为节点对象字典）',
  'comfyui_workflow_reset_hint': '恢复为模板原始内容',
  'comfyui_workflow_required': '模型 {{model_id}} 是自定义模型，必须提供覆盖工作流（选择内置模板或粘贴 JSON）',
  // ComfyUI 多主机池管理（设置页）
  'comfyui_pool_sidebar': 'ComfyUI 主机',
  'comfyui_pool_title': 'ComfyUI 主机池',
  'comfyui_pool_empty_hint': '尚未配置 ComfyUI 主机。在「供应商」中添加一个使用 ComfyUI（本地）端点的供应商后，可在此查看并管理全部主机。',
  'comfyui_pool_load_failed': '加载 ComfyUI 主机失败',
  'comfyui_pool_test_all': '全部测试',
  'comfyui_pool_workflows': '模型工作流',
  'comfyui_workflow_saved': '工作流已保存',
  'comfyui_host_reachable': '可达',
  'comfyui_host_unreachable': '不可达',
  'comfyui_host_unknown': '未检测',
  'comfyui_load_label': '负载 {{count}}',
  'comfyui_load_unknown': '负载未知',
  // Image Capability
