...
export default {
  ...
  'endpoint_comfyui_video_display': 'ComfyUI (Cục bộ)',
  'endpoint_openai_tts_display': 'OpenAI Giọng nói (TTS)',
  'endpoint_catalog_loading': 'Đang tải danh mục endpoint…',
  // ComfyUI workflow config (trong hàng mô hình của endpoint comfyui-video)
  'comfyui_workflow_label': 'Workflow',
  'comfyui_workflow_template_label': 'Mẫu tích hợp',
  'comfyui_workflow_template_minimax_h3_ref2va': 'Ref2VA 20 bước tiêu chuẩn',
  'comfyui_workflow_template_minimax_h3_ref2va_8step': '8 bước Turbo LoRA',
  'comfyui_workflow_template_minimax_h3_ref2va_8step_fp8': '8 bước Turbo LoRA (FP8)',
  'comfyui_workflow_follow_default': 'Theo mẫu tích hợp',
  'comfyui_workflow_no_template': 'Chọn mẫu tích hợp để bắt đầu',
  'comfyui_workflow_edit_json': 'Sửa JSON',
  'comfyui_workflow_hide_json': 'Thu gọn JSON',
  'comfyui_workflow_help_custom': 'Mô hình tùy chỉnh cần workflow ghi đè: bắt đầu từ mẫu tích hợp rồi sửa JSON khi cần. Workflow phải chứa nút MiniMaxH3ReferenceToVideo và SaveVideo.',
  'comfyui_workflow_json_label': 'JSON workflow ghi đè',
  'comfyui_workflow_json_placeholder': '{"nodeID": {"class_type": "...", "inputs": {...}}, ...}',
  'comfyui_workflow_json_invalid': 'JSON không hợp lệ — hãy kiểm tra cú pháp',
  'comfyui_workflow_json_not_graph': 'JSON không phải đồ thị workflow ComfyUI hợp lệ (từ điển các nút)',
  'comfyui_workflow_reset_hint': 'Khôi phục nội dung mẫu gốc',
  'comfyui_workflow_required': 'Mô hình {{model_id}} là mô hình tùy chỉnh, cần workflow ghi đè (chọn mẫu tích hợp hoặc dán JSON)',
  // Quản lý cụm máy chủ ComfyUI (trang cài đặt)
  'comfyui_pool_sidebar': 'Máy chủ ComfyUI',
  'comfyui_pool_title': 'Cụm máy chủ ComfyUI',
  'comfyui_pool_empty_hint': 'Chưa cấu hình máy chủ ComfyUI. Hãy thêm nhà cung cấp dùng endpoint ComfyUI (Cục bộ) trong mục «Nhà cung cấp» để quản lý toàn bộ máy chủ tại đây.',
  'comfyui_pool_load_failed': 'Tải danh sách máy chủ ComfyUI thất bại',
  'comfyui_pool_test_all': 'Kiểm tra tất cả',
  'comfyui_pool_workflows': 'Workflow mô hình',
  'comfyui_workflow_saved': 'Đã lưu workflow',
  'comfyui_host_reachable': 'Truy cập được',
  'comfyui_host_unreachable': 'Không truy cập được',
  'comfyui_host_unknown': 'Chưa kiểm tra',
  'comfyui_load_label': 'Tải {{count}}',
  'comfyui_load_unknown': 'Không rõ tải',
  // Image Capability
