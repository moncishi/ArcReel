...
export default {
  ...
  'endpoint_comfyui_video_display': 'ComfyUI (Local)',
  'endpoint_openai_tts_display': 'OpenAI Speech (TTS)',
  'endpoint_catalog_loading': 'Loading endpoint catalog…',
  // ComfyUI workflow config (per-model row inside comfyui-video endpoint)
  'comfyui_workflow_label': 'Workflow',
  'comfyui_workflow_template_label': 'Built-in template',
  'comfyui_workflow_template_minimax_h3_ref2va': 'Standard 20-step Ref2VA',
  'comfyui_workflow_template_minimax_h3_ref2va_8step': '8-step Turbo LoRA',
  'comfyui_workflow_template_minimax_h3_ref2va_8step_fp8': '8-step Turbo LoRA (FP8)',
  'comfyui_workflow_follow_default': 'Follow built-in template',
  'comfyui_workflow_no_template': 'Pick a built-in template to start',
  'comfyui_workflow_edit_json': 'Edit JSON',
  'comfyui_workflow_hide_json': 'Collapse JSON',
  'comfyui_workflow_help_custom': 'Custom models need an override workflow: start from a built-in template, then edit the JSON as needed. The workflow must contain MiniMaxH3ReferenceToVideo and SaveVideo nodes.',
  'comfyui_workflow_json_label': 'Override workflow JSON',
  'comfyui_workflow_json_placeholder': '{"nodeID": {"class_type": "...", "inputs": {...}}, ...}',
  'comfyui_workflow_json_invalid': 'Invalid JSON — check the syntax',
  'comfyui_workflow_json_not_graph': 'JSON is not a valid ComfyUI workflow graph (a dictionary of nodes)',
  'comfyui_workflow_reset_hint': 'Restore the original template',
  'comfyui_workflow_required': 'Model {{model_id}} is custom and needs an override workflow (pick a built-in template or paste JSON)',
  // ComfyUI multi-host pool management (settings page)
  'comfyui_pool_sidebar': 'ComfyUI Hosts',
  'comfyui_pool_title': 'ComfyUI Host Pool',
  'comfyui_pool_empty_hint': 'No ComfyUI hosts configured yet. Add a provider using the ComfyUI (Local) endpoint under "Providers" to manage all hosts here.',
  'comfyui_pool_load_failed': 'Failed to load ComfyUI hosts',
  'comfyui_pool_test_all': 'Test all',
  'comfyui_pool_workflows': 'Model workflows',
  'comfyui_workflow_saved': 'Workflow saved',
  'comfyui_host_reachable': 'Reachable',
  'comfyui_host_unreachable': 'Unreachable',
  'comfyui_host_unknown': 'Unknown',
  'comfyui_load_label': 'Load {{count}}',
  'comfyui_load_unknown': 'Load unknown',
  // Image Capability
